...
public:
	...
	{
		// Load object file
		meshCube.LoadFromObjectFile("Engine3DMeshes/mountains.obj");
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		// Clear Screen
		FillRect_SIMD(0, 0, ScreenWidth(), ScreenHeight(), olc::BLACK);
		...
		for (auto& triToRaster : vecTrianglesToRaster)
		{
			...
			{
				FillTriangle_SIMD(t.p[0].x, t.p[0].y, t.p[1].x, t.p[1].y, t.p[2].x, t.p[2].y, t.col);
